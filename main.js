...
$(document).ready(function() {
  ...
  function createPlaylistCard(obj) {
      ...
      $(mainDiv).removeClass("active-card");
      ...
      $(mainDiv).click(function(){
        ...
        // load that playlist video in video player

        var videoPlayerToLoad = videoPlaySectionData[parseInt(this.id)-1];

        // console.log(videoPlayerToLoad);
        $(this).addClass("active-card");
        //https://player.vimeo.com/video/190062231"
        var videoPlayer = $("#video-player");
        videoPlayer.attr("src","https://player.vimeo.com/video/"  + videoPlayerToLoad.vimeoId);

        var viewsCount = $("#views-count");
        viewsCount.html(videoPlayerToLoad.views);

        var videoTitle = $("#video-title");
        videoTitle.html(videoPlayerToLoad.title);

        var videoDesc = $("#video-description");
        videoDesc.html(videoPlayerToLoad.description);
        //click functionality on like and book mark.
  ...
  for(var i = 0; i < playlistData.length;i++){ 
    // console.log(createPlaylistCard(playlistData[i]).title);
